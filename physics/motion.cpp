...
void Plteen::IMovable::set_acceleration(double acc, double dir, bool is_radian) {
    double ax = 0.0;
    double ay = 0.0;
...
void Plteen::IMovable::set_delta_speed(double xacc, double yacc) {
...
void Plteen::IMovable::add_delta_speed(double xacc, double yacc) {
...
void Plteen::IMovable::add_acceleration(double acc, double dir, bool is_radian) {
    double ax = 0.0;
    double ay = 0.0;
...
double Plteen::IMovable::get_acceleration(double* direction, double* x, double* y) {
...
double Plteen::IMovable::get_acceleration_direction(bool need_radian) {
    double rad = this->ar;
...
void Plteen::IMovable::set_velocity(double spd, double dir, bool is_radian) {
    double vx = 0.0;
    double vy = 0.0;
...
void Plteen::IMovable::add_velocity(double spd, double dir, bool is_radian) {
    double vx = 0.0;
    double vy = 0.0;
...
void Plteen::IMovable::set_speed(double xspd, double yspd) {
...
void Plteen::IMovable::add_speed(double xspd, double yspd) {
    this->set_speed(this->vx + xspd, this->vy + yspd);
}

double Plteen::IMovable::get_velocity(double* direction, double* x, double* y) {
...
double Plteen::IMovable::get_velocity_direction(bool need_radian) {
    double rad = this->vr;

    return (need_radian ? rad : radians_to_degrees(rad));
}

void Plteen::IMovable::set_terminal_velocity(double v, double dir, bool is_radian) {
    double vx = 0.0;
    double vy = 0.0;
...
void Plteen::IMovable::set_terminal_speed(double mxspd, double myspd) {
    bool changed = false;
...
void Plteen::IMovable::set_heading(double dx, double dy) {
    // Usually this is meaningful when stopped
    this->set_heading(flatan(dy, dx), true);
}

void Plteen::IMovable::set_heading(double direction, bool is_radian) {
    // Usually this is meaningful when stopped
...
void Plteen::IMovable::add_heading(double theta, bool is_radian) {
    // Usually this is meaningful when stopped
...
void Plteen::IMovable::heading_rotate(double theta, bool is_radian) {
    if (theta != 0.0) {
...
void Plteen::IMovable::on_border(float hoffset, float voffset) {
...
void Plteen::IMovable::set_border_strategy(BorderStrategy s) {
    this->set_border_strategy(s, s, s, s);
}

void Plteen::IMovable::set_border_strategy(BorderStrategy vs, BorderStrategy hs) {
    this->set_border_strategy(vs, hs, vs, hs);
}
    
void Plteen::IMovable::set_border_strategy(BorderStrategy ts, BorderStrategy rs, BorderStrategy bs, BorderStrategy ls) {
...
void Plteen::IMovable::step(float* sx, float* sy) {
...
void Plteen::IMovable::step(double* sx, double* sy) {
...
void Plteen::IMovable::motion_bounce(bool horizon, bool vertical) {
    if (horizon) {
        this->vx *= -1.0;
...
void Plteen::IMovable::motion_stop(bool horizon, bool vertical) {
    if (horizon) {
        this->vx = 0.0;
        this->ax = 0.0;
    }
...
/*************************************************************************************************/
void Plteen::IMovable::on_acceleration_changed() {
    this->ar = flatan(this->ay, this->ax);
}

void Plteen::IMovable::on_velocity_changed(bool always_trigger_heading_event) {
    double rad = flatan(this->vy, this->vx);

    this->check_heading_changing(rad, always_trigger_heading_event);
}

void Plteen::IMovable::check_velocity_changing() {
...
void Plteen::IMovable::check_heading_changing(double rad, bool always_trigger_event) {
    if (this->vr != rad) {
        double pvr = this->vr;
